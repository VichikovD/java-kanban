...
abstract public class TaskManagerTest<T extends TaskManager> {
    ...
    public void getPrioritized1ShouldReturn2NullTimeTasks() {
        Task madeTask1 = new Task(1, "name", Status.NEW, "description");
    ...
    public void getPrioritized2ShouldAddOnly1Subtask() {
        Epic madeEpic1 = new Epic(1, "Epic1 name", "Epic1 description");
        taskManager.createEpic(madeEpic1);

        Subtask madeSubtask1 = new Subtask(3, "Subtask1 name", Status.DONE, "Subtask1 description",
                Instant.parse("2023-01-01T00:00:00.000Z"), Duration.ofDays(31).toMinutes(), 1);
        taskManager.createSubtask(madeSubtask1);
        Subtask madeSubtask = new Subtask(4, "Subtask2 name", Status.DONE, "Subtask2 description",
                Instant.parse("2023-01-01T00:00:00.000Z"), Duration.ofDays(31).toMinutes(), 1);
    ...
    public void createTask1ShouldAddCopyOfTaskButWithCorrectIdToTasksMap() {
        ...
        Task madeTask = new Task(2, "name", Status.NEW, "description");
        ...
        assertEquals(expectedTask, savedTask, "Task not created correctly or getTaskById didn't return correct Task");
    }

    @Test
    public void createTask2ShouldNotCreateSecondTask() {
        Task madeTask1 = new Task(1, "name", Status.NEW, "description", Instant.parse("2023-01-01T00:00:00.000Z"),
                Duration.ofDays(31).toMinutes());
        taskManager.createTask(madeTask1);

        Task madeTask2 = new Task(2, "name", Status.NEW, "description", Instant.parse("2023-01-01T00:00:00.000Z"),
                Duration.ofDays(31).toMinutes());
        taskManager.createTask(madeTask2);
    ...
    public void updateTask1ShouldUpdateTaskInTasksMap() {
        Task madeTask = new Task(1, "name", Status.NEW, "description");
        taskManager.createTask(madeTask);

        Task updatedTask = new Task(1, "New Name", Status.DONE, "New Description",
                Instant.parse("2023-01-01T00:00:00.000Z"), Duration.ofDays(31).toMinutes());
        ...
        assertEquals(expectedTask, actualTask, "Task not updated correctly or getTaskById didn't return correct Task");
    }

    @Test
    public void updateTask2ShouldUpdateTaskIvenWithSameStartTime() {
        Task madeTask = new Task(1, "name", Status.NEW, "description", Instant.parse("2023-01-01T00:00:00.000Z"),
                Duration.ofDays(31).toMinutes());
        taskManager.createTask(madeTask);
 ...
 /*
    ...
    public void createSubtask1ShouldAddSubtaskToSubtasksMapAndAddToEpicSubtaskList() {
        ...
        Subtask madeSubtask = new Subtask(5, "Subtask1 name", Status.DONE, "Subtask1 description",
    ...
    public void updateSubtask1() {
        ...
        Subtask madeSubtask1 = new Subtask(5, "Subtask name", Status.DONE, "Subtask1 description",
                Instant.parse("2023-01-01T00:00:00.000Z"), Duration.ofDays(31).toMinutes(), 1);
        taskManager.createSubtask(madeSubtask1);
    ...
    public void updateSubtask2ShouldThrowExceptionDueToNotCorrectUpdatedEpicId() {
        Epic madeEpic = new Epic(1, "Epic nameUpd2", "Epic descriptionUpd2");
        taskManager.createEpic(madeEpic);

        Subtask madeSubtask = new Subtask(4, "Subtask nameUpd2", Status.NEW, "Subtask descriptionUpd2", null, 0, 1);
        taskManager.createSubtask(madeSubtask);
...
*/
    ...
    public void getSubtasksListByEpicId() {
        ...
        Subtask madeSubtask1 = new Subtask(2, "Subtask1 name", Status.NEW, "Subtask1 description",
                Instant.parse("2023-05-01T13:00:00.000Z"), Duration.ofDays(31).toMinutes(), 1);
        taskManager.createSubtask(madeSubtask1);

        Subtask madeSubtask2 = new Subtask(3, "Subtask2 name", Status.NEW, "Subtask2 description",
        ...
        List<Subtask> expectedList = List.of(
                ...
                new Subtask(3, "Subtask2 name", Status.NEW, "Subtask2 description",
                        Instant.parse("2023-07-01T13:00:00.000Z"), Duration.ofDays(31).toMinutes(), 1));
        List<Subtask> actualList = taskManager.getSubtasksListByEpicId(1);
    ...
    public void getAllTasks() {
        ...
        taskManager.createTask(madeTask1);
        Task madeTask2 = new Task(2, "name2", Status.NEW, "description2");
        taskManager.createTask(madeTask2);
    ...
    public void getAllSubtasks() {
        ...
        Subtask madeSubtask1 = new Subtask(
                2, "Subtask name1", Status.NEW, "Subtask description1", null, 0, 1);
        taskManager.createSubtask(madeSubtask1);
        Subtask madeSubtask2 = new Subtask(
                3, "Subtask name2", Status.NEW, "Subtask description2", null, 0, 1);
        taskManager.createSubtask(madeSubtask2);
    ...
    public void getAllEpics() {
        Epic madeEpic1 = new Epic(1, "Epic name1", "Epic description1");
        taskManager.createEpic(madeEpic1);
        Epic madeEpic2 = new Epic(2, "Epic name2", "Epic description2");
        taskManager.createEpic(madeEpic2);
        Subtask madeSubtask1 = new Subtask(
                3, "Subtask name1", Status.DONE, "Subtask description1", Instant.parse("2023-07-01T13:00:00.000Z"),
...
*/
    ...
    public void getSubtaskById() {
        ...
        Subtask madeSubtask = new Subtask(2, "name1", Status.NEW, "description1", null, 0, 1);
        taskManager.createSubtask(madeSubtask);
    ...
    public void getSubtaskById2ShouldThrowException() {
        ...
        Subtask madeSubtask = new Subtask(2, "name1", Status.NEW, "description1", 1);
        taskManager.createSubtask(madeSubtask);
   ...
   /* @Test
    ...
    public void deleteTaskByIdShouldDelete1TaskAndDeleteFromPrioritized() {
        Task madeTask = new Task(1, "name1", Status.NEW, "description1");
        taskManager.createTask(madeTask);
        Task madeTask2 = new Task(2, "name2", Status.NEW, "description2");
        taskManager.createTask(madeTask2);
        ...
        List<Task> expected = List.of(new Task(2, "name2", Status.NEW, "description2"));
        List<Task> actual = taskManager.getAllTasks();
        assertEquals(expected, actual, "Deleted not 1 task or getAllTasks returned not correct data");

        List<Task> expectedPrioritized = List.of(new Task(2, "name2", Status.NEW, "description2", null, 0));
    ...
    public void deleteSubtaskByIdShouldDelete1SubtaskAndUpdatePrioritizedTasksAndUpdateEpic() {
        ...
        Subtask madeSubtask1 = new Subtask(2, "Subtask name1", Status.DONE, "Subtask description1",
                Instant.parse("2023-03-01T13:00:00.000Z"), Duration.ofDays(31).toMinutes(), 1);
        taskManager.createSubtask(madeSubtask1);

        Subtask madeSubtask2 = new Subtask(3, "Subtask name2", Status.NEW, "Subtask description2",
                Instant.parse("2023-07-01T13:00:00.000Z"), Duration.ofDays(31).toMinutes(), 1);
        taskManager.createSubtask(madeSubtask2);
        ...
        List<Subtask> expectedSubtasks = List.of(
                new Subtask(3, "Subtask name2", Status.NEW, "Subtask description2",
                        Instant.parse("2023-07-01T13:00:00.000Z"), Duration.ofDays(31).toMinutes(), 1));
        ...
        List<Task> expectedPrioritized = List.of(new Subtask(3, "Subtask name2", Status.NEW, "Subtask description2",
                Instant.parse("2023-07-01T13:00:00.000Z"), Duration.ofDays(31).toMinutes(), 1));
        List<Task> actualPrioritized = taskManager.getPrioritizedTasks();
        assertEquals(expectedPrioritized, actualPrioritized,
    ...
    public void deleteSubtaskById2ShouldThrowException() {
        Epic madeEpic = new Epic(1, "Epic name", Status.NEW, "Epic description");
        taskManager.createEpic(madeEpic);

        Subtask madeSubtask1 = new Subtask(
                2, "Subtask name1", Status.NEW, "Subtask description1", 1);
        taskManager.createSubtask(madeSubtask1);
    ...
    public void deleteEpicById1ShouldDelete1EpicAndDelete1SubtaskAndUpdatePrioritizedTasks() {
        ...
        Subtask madeSubtask1 = new Subtask(3, "Subtask name1", Status.NEW, "Subtask description1",
                Instant.parse("2023-07-01T13:00:00.000Z"), Duration.ofDays(13).toMinutes(), 1);
        taskManager.createSubtask(madeSubtask1);
        Subtask madeSubtask2 = new Subtask(4, "Subtask name2", Status.DONE, "Subtask description2",
                Instant.parse("2023-01-01T13:00:00.000Z"), Duration.ofDays(31).toMinutes(), 2);
        taskManager.createSubtask(madeSubtask2);
        ...
        List<Task> expectedPrioritized = List.of(new Subtask(4, "Subtask name2", Status.DONE, "Subtask description2",
                Instant.parse("2023-01-01T13:00:00.000Z"), Duration.ofDays(31).toMinutes(), 2));
        List<Task> actualPrioritized = taskManager.getPrioritizedTasks();
        assertEquals(expectedPrioritized, actualPrioritized,
    ...
    public void deleteEpicById2ShouldThrowException() {
        Epic madeEpic1 = new Epic(1, "Epic name", Status.NEW, "Epic description");
        taskManager.createEpic(madeEpic1);
    ...
    public void deleteAllEpics() {
        Task task = new Task(1, "name", Status.NEW, "description", Instant.parse("2022-10-01T00:00:00.000Z"),
                Duration.ofDays(31).toMinutes());
        taskManager.createTask(task);

        Epic madeEpic1 = new Epic(2, "Epic1 name", "Epic1 description");
        taskManager.createEpic(madeEpic1);
        Epic madeEpic2 = new Epic(3, "Epic2 name", "Epic2 description");
        taskManager.createEpic(madeEpic2);

        Subtask madeSubtask1 = new Subtask(4, "Subtask name1", Status.DONE, "Subtask description1",
                Instant.parse("2023-01-01T13:00:00.000Z"), Duration.ofDays(31).toMinutes(), 2);
        taskManager.createSubtask(madeSubtask1);
        Subtask madeSubtask2 = new Subtask(5, "Subtask name2", Status.IN_PROGRESS, "Subtask description2",
                Instant.parse("2023-04-01T00:00:00.000Z"), Duration.ofDays(31).toMinutes(), 3);
        taskManager.createSubtask(madeSubtask2);
    ...
    public void deleteAllSubtasks() {
        Task task = new Task(1, "name", Status.NEW, "description", Instant.parse("2023-04-01T00:00:00.000Z"),
                Duration.ofDays(31).toMinutes());
        taskManager.createTask(task);
        ...
        taskManager.createSubtask(madeSubtask1);
        Subtask madeSubtask2 = new Subtask(4, "Subtask name2", Status.DONE, "Subtask description2",
                Instant.parse("2022-10-01T00:00:00.000Z"), Duration.ofDays(31).toMinutes(), 3);
        taskManager.createSubtask(madeSubtask2);
    ...
    public void deleteAllTasks() {
        Epic madeEpic2 = new Epic(1, "Epic2 name", "Epic2 description");
        taskManager.createEpic(madeEpic2);
        ...
        Task madeTask1 = new Task(3, "name1", Status.NEW, "description1", Instant.parse("2023-02-01T00:00:00.001Z"),
                Duration.ofDays(31).toMinutes());
        taskManager.createTask(madeTask1);
